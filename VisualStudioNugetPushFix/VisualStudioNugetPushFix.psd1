#
# Module manifest for module 'VisualStudioNugetPushFix'
#
# Generated by: David
#
...
NestedModules = @('.\Public\Publish-VisualStudioNugetv3Feed.ps1')
...
FileList = 'puild.json', 'VisualStudioNugetPushFix.psd1', 
